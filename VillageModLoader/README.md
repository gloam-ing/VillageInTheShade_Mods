...
- Injects a built-in crash reporter first; if the game crashes, it writes
  `mod_crash.log` (exception code, read/write flag + target address,
  faulting module+offset, registers, stack with module names) in the game
  root.
...
Installation
------------
1. Put VillageModLoader_v1.0.2.exe in the game's Mods folder.
...
3. In Steam, right-click the game -> Properties -> Launch Options,
   and enter:
     "D:\Steam\steamapps\common\Village in the Shade\Mods\VillageModLoader_v1.0.2.exe" %command%
...
- Delete VillageModLoader_v1.0.2.exe and any mod folders you no longer want.

Files in this package
---------------------
- VillageModLoader_v1.0.2.exe - the loader itself (with built-in crash log)
